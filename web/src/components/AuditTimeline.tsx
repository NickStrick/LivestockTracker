...
const META: Record<string, { icon: IconDefinition; tone: string }> = {
  ...
  health_recorded: { icon: faHeartPulse, tone: "bg-warn/15 text-warn" },
  weight_recorded: { icon: faWeightScale, tone: "bg-accent/15 text-accent" },
  estimate_recorded: { icon: faSackDollar, tone: "bg-ok/15 text-ok" },
  lineage_updated: { icon: faDna, tone: "bg-info/15 text-info" },
